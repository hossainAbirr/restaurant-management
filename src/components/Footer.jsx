...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-800 text-gray-100">
                ...
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full">
                            <img className="w-96 rounded-xl" src="https://logowik.com/content/uploads/images/restaurant9491.logowik.com.webp" alt="" />
                        </div>
                        <span className="self-center text-2xl font-semibold">Abir&apos;s Restaurant</span>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center text-gray-400">© Abir&apos;s Restaurant. All rights reserved.</div>
        </footer>
    );
};
